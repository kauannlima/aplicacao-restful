...
import br.com.klima.configs.integrationtests.vo.wrappers.WrapperPersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest{
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8888/api/person/v1/564\"}}}"));
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8888/api/person/v1/130\"}}}"));
