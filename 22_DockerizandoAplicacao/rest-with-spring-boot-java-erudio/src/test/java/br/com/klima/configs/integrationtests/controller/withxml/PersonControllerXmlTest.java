...
public class PersonControllerXmlTest extends AbstractIntegrationTest{
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("<href>http://localhost:8888/api/person/v1/957</href></links>"));
		assertTrue(content.contains("<href>http://localhost:8888/api/person/v1/130</href></links>"));
		assertTrue(content.contains("<href>http://localhost:8888/api/person/v1/155</href></links>"));
